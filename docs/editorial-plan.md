...
| 아이디어 | 미정 | [논문 리뷰] SENTINEL-RL — SOC agent의 graph reasoning을 외부 엔진에 맡기기 | paper-review | AI 평가/운영 | | arXiv 2609.04159 — SOC agent의 topology reasoning offload, graph query tool boundary, alert triage evidence trace 설계 |
