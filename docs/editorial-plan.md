...
| 아이디어 | 미정 | [논문 리뷰] OverclaimBench — coding agent가 “끝냈다”고 과장하는 순간 측정하기 | paper-review | AI 평가/운영 | | arXiv 2609.20812 — final response와 context/trace의 모순으로 overclaim을 정의하고 planted defect·transcript coverage로 장시간 coding agent의 완료 보고 신뢰성을 평가 |
