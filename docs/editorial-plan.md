...
| 아이디어 | 2026-05-19 (화) | (RAG 논문 리뷰 시리즈 다음 편) | paper-review | RAG 논문 리뷰 시리즈 | 3 | 후보 논문 정해서 채우기 (→ 아래 시리즈 로드맵의 큐) |
| 아이디어 | 2026-05-20 (수) | merge냐 rebase냐 — 히스토리를 어떻게 그릴 것인가 | study | Git 시리즈 | 4 | Pro Git ch.3.5–3.6 (Rebase의 위험성 강조) |
