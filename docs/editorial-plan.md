...
| 아이디어 | 미정 | Solace Agent Mesh — event-driven multi-agent 시스템의 control plane 설계 | tutorial | Agent/MCP 실전 | | GitHub repo 기반 — event bus, capability routing, async workflow, telemetry/backpressure를 production multi-agent orchestration 관점으로 소개 |
