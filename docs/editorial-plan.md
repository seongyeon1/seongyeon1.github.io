...
| 아이디어 | 미정 | [논문 리뷰] CliffCompaction — long-horizon coding agent의 context compaction 비용 줄이기 | paper-review | 개발자 AI 워크플로 | | arXiv 2609.26779 — bounded context에서 autocompaction으로 Terminal-Bench/KernelBench 장기 coding agent의 rollout 비용을 줄이고 test-time scaling 효율을 높이는 방식 분석 |
