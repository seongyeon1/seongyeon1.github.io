...
| 아이디어 | 미정 | [논문 리뷰] MidTool — agentic tool-use를 mid-training 데이터 합성으로 키우기 | paper-review | Agent/MCP 실전 | | arXiv 2608.20314 — tool task 생성, trajectory 품질, verifier, generalization failure를 agent post-training 운영법으로 정리 |
