...
| 아이디어 | 미정 | [논문 리뷰] Corrupt Plans, Clean Traces — CoT monitor를 우회하는 plan injection | paper-review | AI 평가/운영 | | arXiv 2609.15989 — chain-of-thought monitor를 안전 gate로 쓸 때 hidden plan injection과 clean trace evasion이 만드는 한계, action-level audit와 counterfactual 검증 필요성 분석 |
