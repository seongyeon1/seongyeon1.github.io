...
| 검토 | 미정 | [논문 리뷰] HyperTool — 에이전트의 도구 호출 단위를 다시 설계하기 | paper-review | 논문 리뷰 | 9 | `2026-06-15-hypertool-agent-tool-call-granularity.mdx` — draft true, typecheck/build 통과, 발행 전 최종 리뷰 필요 |
