...
| 아이디어 | 미정 | [논문 리뷰] Handover of In-Context Learning State — 세션 경계를 넘는 agent state 전달 | paper-review | 논문 리뷰 | | arXiv 2608.14528 — context limit·앱 재시작·subagent delegation에서 resume packet과 handover protocol 설계 |
