...
| 아이디어 | 미정 | [논문 리뷰] Prediction-Powered Smoothing — agent 평가를 적은 라벨로 안정화하기 | paper-review | AI 평가/운영 | | arXiv 2609.20758 — disaggregated AI evaluation에서 작은 라벨 예산과 예측 모델을 결합해 slice별 성능 추정과 drift validation을 안정화하는 통계 계층 정리 |
