...
| 아이디어 | 미정 | [논문 리뷰] EvoSafeHarness — agent safety harness를 model·domain별로 진화시키기 | paper-review | AI 평가/운영 | | arXiv 2609.05903 — indirect prompt injection과 harmful request를 model/domain-specific enforcement layer로 막는 안전 하네스 최적화, over-blocking/under-blocking trade-off 분석 |
