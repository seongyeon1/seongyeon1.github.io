    ...
    <div className="mx-auto max-w-5xl px-6 py-10">
        ...
        {seriesList.map((s) => (
          ...
          >
            ...
            <div className="p-6">
              ...
              <h2 className="mb-4 text-balance text-xl font-bold text-zinc-900 transition-colors group-hover:text-primary-600 dark:text-zinc-100 dark:group-hover:text-primary-400">
                {s.name}
              </h2>
              <ol className="space-y-1.5">
                {s.posts.map((p, i) => (
                  ...
                  >
                    <span className="flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-zinc-100 text-xs font-medium tabular-nums text-zinc-400 dark:bg-zinc-800 dark:text-zinc-500">
                      {i + 1}
                    </span>
      ...
      {seriesList.length === 0 && (
        <div className="flex flex-col items-center justify-center py-20">
          ...
          <p className="text-zinc-500 dark:text-zinc-400">No series yet.</p>
        </div>
      )}
    </div>
  );
